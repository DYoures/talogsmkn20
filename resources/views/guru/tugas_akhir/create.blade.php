...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-white">Buat Tugas Akhir Baru</h2>
    </div>
    ...
    <div class="bg-gray-900 rounded-xl border border-gray-800 p-6">
        <form method="POST" action="{{ route('guru.tugas-akhir.store') }}">
            ...
            <div class="mb-5 p-4 rounded-lg bg-cyan-900/20 border border-cyan-800/50">
                <p class="text-sm text-cyan-300">Tugas akhir ini akan otomatis dibagikan kepada seluruh siswa jurusan <strong class="text-cyan-100">{{ $guru->jurusan->name }}</strong>.</p>
            </div>
